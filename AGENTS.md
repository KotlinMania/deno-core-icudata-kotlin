...
This file is the quick-reference operating contract for deno-core-icudata-kotlin. The longer
...
deno-core-icudata-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`deno_core_icudata`](https://crates.io/crates/deno_core_icudata). Upstream Rust is the behavioral oracle while the
