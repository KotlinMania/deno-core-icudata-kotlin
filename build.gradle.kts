...
kotlin {
    ...
    val xcf = XCFramework("DenoCoreIcudata")
    ...
    watchosArm32 {
        // Keep the 32-bit target compile-only: linking the 10.8 MB ICU blob
        // into a watchOS ARM32 framework exceeds Mach-O scattered relocation
        // encoding, while the Kotlin target metadata remains publishable.
    }
    watchosArm64 {
        binaries.framework { baseName = "DenoCoreIcudata"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "DenoCoreIcudata"
        flattenPackage = "io.github.kotlinmania.denocoreicudata"
    }

    android {
        namespace = "io.github.kotlinmania.denocoreicudata"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "deno-core-icudata-kotlin", version.toString())

    pom {
        name.set("deno-core-icudata-kotlin")
        description.set("Kotlin Multiplatform port of denoland/deno_core_icudata - Raw ICU data for use with deno_core")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/deno-core-icudata-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/deno-core-icudata-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/deno-core-icudata-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/deno-core-icudata-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val generatedSources = fileTree(icuDataGeneratedDir.get().asFile) { include("**/*.kt") }
    val platformSources = fileTree("src/androidMain/kotlin") { include("**/*.kt") }
    val sources = files(commonSources, generatedSources, platformSources)
    ...
    doFirst {
        ...
        val commonSourceFiles = (commonSources.files + generatedSources.files).toMutableList()
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.denocoreicudata.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "assembleDenoCoreIcudataXCFramework",
    "assembleDenoCoreIcudataDebugXCFramework",
    "assembleDenoCoreIcudataReleaseXCFramework",
    "assembleDebugIosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseIosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugMacosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseMacosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugTvosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseTvosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugWatchosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseWatchosFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForDenoCoreIcudataXCFramework",
